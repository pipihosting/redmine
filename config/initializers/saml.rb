Redmine::OmniAuthSAML::Base.configure do |config|
  config.saml = {
    :assertion_consumer_service_url => "http://localhost:3000/auth/saml/callback", # OmniAuth callback URL
    :issuer                         => "http://localhost:3000/saml/metadata",      # The issuer name / entity ID. Must be an URI as per SAML 2.0 spec.
    :single_logout_service_url      => "http://localhost:3000/auth/saml/sls",      # The SLS (logout) callback URL
